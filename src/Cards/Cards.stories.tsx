...
import Cards from '.'
import { Content } from './Cards.style'
...
Vertical.args = {
    ...
    title : 'A title',
    content : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Non ac mi nunc volutpat gravida malesuada eu massa vestibulum.',
    onClick : () => alert('boom'),
}
