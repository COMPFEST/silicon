...
const Toast: React.FC<ToastProps> = ({ ...props }) => {
    const { successMessage = 'Success!', errorMessage = 'Oops.. an error occurs', loadingMessage = 'Loading', promise} = props
    ...
    const callToast = () => toast.promise(
        ...
        },
        {
            ...
            loading: {
                ...
                icon: <StyledLoadingIcon><LoadingIcon /></StyledLoadingIcon>
            },
            error: {
                style:
                {
